<?php
    class InfosaccueilController
    {
        ...
        {
            $sql='SELECT b.identifiant_bon_de_commande, b.date_bon_de_commande, b.format_de_page, b.prix_du_bon_de_commande, b.identifiant_partenaire, b.identifiant_categorie_bon_de_commande, cbdc.libelle_categorie_bon_de_commande, cbdc.identifiant_categorie_bon_de_commande, cbdc.repetition, p.identifiant_partenaire, p.nom_partenaire, p.adresse_partenaire, a.identifiant_partenaire, a.identifiant_categorie_partenaires, cp.identifiant_categorie_partenaires, cp.libelle_categorie_client
            ...
            JOIN categories_de_partenaire cp
            ON cp.identifiant_categorie_partenaires = a.identifiant_categorie_partenaires
