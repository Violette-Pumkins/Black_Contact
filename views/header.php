...
<head>
    ...
    <link rel="stylesheet" href="layout/bs4/css/bootstrap-select.min.css">
    <link rel="stylesheet" href="layout/style.css">
    <title>BlackContact</title>
</head>
<header>
    <nav class="navbar navbar-expand-lg">
        <a class="navbar-brand" href="index.php?action=accueil">BlackContact</a>
